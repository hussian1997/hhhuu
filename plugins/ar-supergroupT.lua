...
local function lock_group_membermod(msg, data, target)
  ...
  if group_member_lock == 'yes' then
    return 'تـــــ👁‍🗨ــم قفل الاضافة بــــــــنجــ🖲ــــــاح\nبواسطه 👀 👈🏿 @'..msg.from.username..'\n'.."الرساله 👀  👈🏿 "..msg.text.."\n" 
  else
    data[tostring(target)]['settings']['lock_member'] = 'yes'
    save_data(_config.moderation.data, data)
  end
    return 'الاضافة بـالفعل مقـــفـــــولة ابـ🖲ـو راس\nبواسطه 👀 👈🏿 @'..msg.from.username..'\n'.."الرساله 👀  👈🏿 "..msg.text.."\n" 
end
...
local function unlock_group_membermod(msg, data, target)
  ...
  if group_member_lock == 'no' then
    return 'تـــــ👁‍🗨ــم فتح الاضافة بــــــــنجــ🖲ــــــاح️\nبواسطه 👀 👈🏿 @'..msg.from.username..'\n'.."الرساله 👀  👈🏿 "..msg.text.."\n" 
  else
    data[tostring(target)]['settings']['lock_member'] = 'no'
    save_data(_config.moderation.data, data)
    return 'الاضافة بـالفعل مفـــتـــــوحة ابـ🖲ـو راس️\nبواسطه 👀 👈🏿 @'..msg.from.username..'\n'.."الرساله 👀  👈🏿 "..msg.text.."\n" 
  end
end
...
local function enable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'yes' then
    return 'تـــــ👁‍🗨ــم قفل الطرد بــــــــنجــ🖲ــــــاح\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  else
    data[tostring(target)]['settings']['strict'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'الطر بـالفعل مقـــفـــــولة ابـ🖲ـو راس\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  end
end
...
local function disable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'no' then
    return 'تـــــ👁‍🗨ــم فتح الاضافة بــــــــنجــ🖲ــــــاح\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  else
    data[tostring(target)]['settings']['strict'] = 'no'
    save_data(_config.moderation.data, data)
    return 'الاضافة بـالفعل مفـــتـــــوحة ابـ🖲ـو راس\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  end
end
...
local function lock_group_username(msg, data, target)
  ...
  if group_username_lock == 'yes' then
    return 'تـــــ👁‍🗨ــم قفل المعرفات بــــــــنجــ🖲ــــــاح\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  else
    data[tostring(target)]['settings']['username'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'المعرفات بـالفعل مقـــفـــــولة ابـ🖲ـو راس\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  end
end
...
local function unlock_group_username(msg, data, target)
  ...
  if group_username_lock == 'no' then
    return 'تـــــ👁‍🗨ــم فتح المعرفات بــــــــنجــ🖲ــــــاح\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  else
data[tostring(target)]['settings']['username'] = 'no'
    save_data(_config.moderation.data, data)
    return 'المعرفات بـالفعل مفـــتـــــوحة ابـ🖲ـو راس\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  end
end
...
local function lock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == 'yes' then
    return 'تـــــ👁‍🗨ــم قفل السمايلات بــــــــنجــ🖲ــــــاح\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  else
    data[tostring(target)]['settings']['emoji'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'السمايلات بـالفعل مقـــفـــــولة ابـ🖲ـو راس\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  end
end
...
local function unlock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == 'no' then
    return 'تـــــ👁‍🗨ــم فتح السمايلات بــــــــنجــ🖲ــــــاح\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  else
    data[tostring(target)]['settings']['emoji'] = 'no'
    save_data(_config.moderation.data, data)
    return 'السمايلات بـالفعل مفـــتـــــوحة ابـ🖲ـو راس\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  end
end
...
local function lock_group_tag(msg, data, target)
  ...
  if group_tag_lock == 'yes' then
    return 'تـــــ👁‍🗨ــم قفل التاكات بــــــــنجــ🖲ــــــاح\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  else
    data[tostring(target)]['settings']['tag'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'التاكات بـالفعل مقـــفـــــولة ابـ🖲ـو راس\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  end
end
...
local function unlock_group_tag(msg, data, target)
  ...
  if group_tag_lock == 'no' then
    return 'تـــــ👁‍🗨ــم فتح التاكات بــــــــنجــ🖲ــــــاح\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  else
    data[tostring(target)]['settings']['tag'] = 'no'
    save_data(_config.moderation.data, data)
    return 'التاكات بـالفعل مفـــتـــــوحة ابـ🖲ـو راس\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  end
end
...
local function lock_group_cmd(msg, data, target)
  ...
  if group_cmd_lock == 'yes' then
    return 'تـــــ👁‍🗨ــم قفل الشارحه بــــــــنجــ🖲ــــــاح\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  else
    data[tostring(target)]['settings']['cmd'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'الشارحه بـالفعل مقـــفـــــولة ابـ🖲ـو راس\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  end
end
...
local function unlock_group_cmd(msg, data, target)
  ...
  if group_cmd_lock == 'no' then
    return 'تـــــ👁‍🗨ــم فتح الشارحه بــــــــنجــ🖲ــــــاح\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  else
    data[tostring(target)]['settings']['cmd'] = 'no'
    save_data(_config.moderation.data, data)
    return 'الشارحه  بـالفعل مفـــتـــــوحة ابـ🖲ـو راس\nبواسطه 🎈 ➖ @'..msg.from.username..'\n'.."الرساله 🎈  ➖ "..msg.text.."\n" 
  end
end
